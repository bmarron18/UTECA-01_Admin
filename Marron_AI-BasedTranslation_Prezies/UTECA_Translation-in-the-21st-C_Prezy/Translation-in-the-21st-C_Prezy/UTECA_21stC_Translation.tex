...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4.5) {\includegraphics[scale=.4]{graphics/ML1}};  
 \end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4.5) {\includegraphics[scale=.4]{graphics/ML2}};  
 \end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (-1,-3.3) {\includegraphics[scale=.28]{graphics/Google_1.png}};
 \end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (-1,-3.3) {\includegraphics[scale=.28]{graphics/Python_1.png}};
 \end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.31]{graphics/Python_2.png}};
 \end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.31]{graphics/Python_3.png}};
 \end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.31]{graphics/Python_4.png}};
 \end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.31]{graphics/Python_5.png}};
 \end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.27]{graphics/Original_Latex.pdf}};
\end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.27]{graphics/gcTranslate_output_fr_Latex.pdf}};
\end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.27]{graphics/gcTranslate_output_de_Latex.pdf}};
\end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.27]{graphics/gcTranslate_output_ja_Latex.pdf}};
\end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (0,-4) {\includegraphics[scale=.27]{graphics/gcTranslate_output_hi_Latex.pdf}};
\end{tikzpicture}
...
\begin{tikzpicture}[overlay]
  \node[anchor=south west] at (-0.1,2.5) {\includegraphics[scale=.15]{graphics/Anaconda.png}};
  \node[anchor=south west] at (5,2.5) {\includegraphics[scale=.05]{graphics/Spyder.png}};
\end{tikzpicture}
